  ...
  const columns = [
    {
      ...
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.NO,
    },

    {
      ...
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      sorter: {},
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.NAME,
      ellipsis: true,
    },

    {
      ...
      dataIndex: 'email',
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.EMAIL,
      ellipsis: true,
    },

    {
      ...
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.PHONE_NUMBER,
    },

    {
      ...
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.CONTRACT_DATE,
      sorter: {
...

    {
      ...
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.EMPLOYEE_STATUS,
      render: (value) => (
        <Switch
...

    {
      ...
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.CONTRACT_STATUS,
      render: (value) =>
...

    {
      ...
      fixed: 'right',
      dataIndex: 'action',
      width: constant.TABLE.EMPLOYEE_COLUMN_WIDTH.ACTION,
      align: constant.TABLE.COLUMN_FIXED.CENTER,
      render: (value) => (
